...
channelsx = [
    ...
    "武术世界,http://8.8.8.8:8/udp/239.76.245.181:1234","凤凰中文,http://8.8.8.8:8/udp/239.76.246.134:1234",
    ...
    "CHC家庭影院,http://8.8.8.8:8/udp/239.76.245.241:1234", "长沙影视,http://8.8.8.8:8/udp/239.76.252.204:9000",
    ...
    "都市剧场,http://8.8.8.8:8/udp/239.76.253.215:9000", "湖南都市,http://8.8.8.8:8/udp/239.76.252.117:9000", 
    ...
    "湘西公共,http://8.8.8.8:8/udp/239.76.252.210:9000", "湖南教育,http://8.8.8.8:8/udp/239.76.252.233:9000"
]
...
for url in urls:
    url_0 = str(base64.b64encode((f'"Server: udpxy" && country="CN" && region="{url}" && org="Chinanet"').encode("utf-8")), "utf-8")
